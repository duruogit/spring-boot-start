...
<style type="text/css">
	.logo {
   		background: url("${ctx}/${sys_web_logo}") no-repeat scroll 0 0 rgba(0, 0, 0, 0);
	    float: left;
	    height: 40px;
	...
	<nav class="navbar navbar-static-top" role="navigation"
		...
		<div class="navbar-header">
			<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
				href="#"><i class="fa fa-bars"></i> </a> <a class="logo"
				href="http://www.saofu.cn/">${sys_web_name }</a>
		</div>
		<ul class="nav navbar-top-links navbar-right">
			<li><span class="m-r-sm text-muted welcome-message"> <a
					href="index.html" title="返回首页"> <i class="fa fa-home"></i>
				</a>欢迎使用H+后台主题
			</span></li>
			...
			<li><a href="login.html"> <i class="fa fa-sign-out"></i> 退出
			</a></li>
		</ul>
	</nav>
</div>